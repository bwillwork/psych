...
import {
  ...
  FiveScaleQuestion, FourMultipleChoiceQuestion,
  TrueFalseQuestion,
  TwoMultipleChoiceQuestion
} from '../types/test.types';
import {
  initFiveMultipleChoiceQuestion,
  initFiveScaleQuestion, initFourMultipleChoiceQuestion,
  initTrueFalseQuestion,
  initTwoMultipleChoiceQuestion
} from './question.util';
...
export class Temp {
  private bigFiveQuestions: WritableSignal<Array<FiveScaleQuestion>> = signal([
  ...
  private myersBrigsQuestions: WritableSignal<Array<TwoMultipleChoiceQuestion>> = signal([
  ...
  private penQuestions: WritableSignal<Array<TrueFalseQuestion>> = signal([
  ...
  private fiveModernRelQuestions:  WritableSignal<Array<FiveMultipleChoiceQuestion>> = signal([
  ...
  private seductionQuestions: WritableSignal<Array<FourMultipleChoiceQuestion>> = signal([
  ...
  private sixStylesQuestions: WritableSignal<Array<FiveScaleQuestion>> = signal([
